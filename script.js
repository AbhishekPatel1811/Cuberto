function loco() {
  ...
  ScrollTrigger.scrollerProxy(".main", {
    ...
    // So to get the correct behavior and avoid jitters, we should pin things with position: fixed on mobile. We sense it by checking to see if there's a transform applied to
